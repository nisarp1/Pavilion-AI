# Deploying Instagram Reel Changes to Cloudways

Since the changes have been pushed to GitHub, you now need to pull them onto your Cloudways server and restart the services.
...
2. **Deploy Backend (New Fields & Logic):**
   ```bash
   # Navigate to backend
   ...
   # Run migrations (CRITICAL for new fields)
...
4. **Verify:**
   - Go to https://dev.pavilionend.in/admin
   - Edit an article
   - You should see the "Instagram Reel Script" section below the summary.

**Note:** If you are testing locally on your laptop, the changes are already applied! Refresh your local browser at http://localhost:5173/admin (or whatever your local URL is).
